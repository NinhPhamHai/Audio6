.class public final enum Lc/g/a/C;
...
.method public a(Landroid/content/Context;Landroid/net/Uri;Lcom/b/common/UrlHandler;Ljava/lang/String;)V
    ...
    .line 7
    invoke-virtual {p0, p4}, Lc/g/a/C;->shouldTryHandlingUrl(Landroid/net/Uri;)Z
    ...
    .line 8
    :try_start_1
    invoke-static {p1, p4}, Lcom/b/common/util/Intents;->launchApplicationUrl(Landroid/content/Context;Landroid/net/Uri;)V

    const/4 p4, 0x0

    .line 9
    invoke-static {v0, p1, p4}, Lcom/b/network/TrackingRequest;->makeTrackingHttpRequest(Ljava/lang/Iterable;Landroid/content/Context;Lcom/b/network/TrackingRequest$Listener;)V
    :try_end_1
    ...
    .line 11
    invoke-virtual {p3, p1, v1, p4, p2}, Lcom/b/common/UrlHandler;->handleUrl(Landroid/content/Context;Ljava/lang/String;ZLjava/lang/Iterable;)V
